...
export const tasksReducer = (state: TasksType = initialState, action: ActionTaskType):TasksType => {
    switch (action.type) {
        case 'REMOVE-TASK':
            return {
                ...state,
        ...
        case 'ADD-TASK':
            ...
            return {
                ...state, [action.todolistId]: {...state[action.todolistId], data: [task, ...state[action.todolistId].data]}
            }
